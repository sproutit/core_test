...
// generates a test.  Assume sync unless returns a promise (that implements
// 'then'() in which case add a listener)
function testFor(func) {
  return function(t, done) {
    var ret = func(t);
    if (ret && ('function' === typeof ret.then)) {
