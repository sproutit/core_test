...
exports.module = function(moduleName, opts) {
  ...
  Ct.setup(function(t, done) {
    ...
    var st = {
      test: t,
      callback: done, // changes as we step through each phase
...
exports.test  = function(testName, handler) {
  ...
  Ct.test(testName, function(t, done) {
    var st = Ct.qUnitStatus;
